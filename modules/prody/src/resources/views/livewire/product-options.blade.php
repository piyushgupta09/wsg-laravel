<div class="card border-0 mb-3">
    ...
    <div class="card-header rounded-0 bg-dark py-2 d-flex justify-content-between align-items-center w-100">
        <div class="d-flex align-items-center flex-fill">
            <button class="btn border-0 ps-0 text-white" type="button" 
                data-bs-toggle="collapse" data-bs-target="#productOptionsList" 
                aria-expanded="true" aria-controls="productOptionsList">
                <i class="bi bi-chevron-down me-2"></i>
                <span class="font-quick ls-1 fw-bold">Product Options (Colors)</span>
            </button>
        </div>
        <div class="">
            <button 
                ...
                <div class="col-md-6 mb-3">
                    ...
                    @else
                        <a class="h-100 w-100 btn btn-light d-flex flex-column justify-content-center align-items-start" 
                            href="{{ route('materials.show', $productMaterial->material->id) }}">
