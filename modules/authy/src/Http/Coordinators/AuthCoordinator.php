...
class AuthCoordinator extends Coordinator
{
    ...
    public function userProfile(Request $request)
    {
        ...
        $userParty = null;
        $userPartyResourceClass = '\Fpaipl\Brandy\Http\Resources\UserPartyResource';
        if (class_exists($userPartyResourceClass)) {
            $user->load('party');
            if ($user->hasParty()) {
                $userParty = new $userPartyResourceClass($user->party);
            }
        }
