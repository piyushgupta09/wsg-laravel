...
use Fpaipl\Authy\Http\Controllers\AccountController;
use Fpaipl\Authy\Http\Controllers\PincodeController;
use Fpaipl\Authy\Http\Controllers\ProfileController;
use Fpaipl\Authy\Http\Controllers\RegisterController;
use Fpaipl\Authy\Http\Controllers\NewAccountController;
...
Route::middleware(['web'])->group(function () {
    ...
    Route::resource('accounts', AccountController::class)->withTrashed(['show']);
    Route::resource('new-accounts', NewAccountController::class)->withTrashed(['show']);

    Route::middleware(['auth','verified', 'role:admin'])->group(function () {
        Route::get('import-pincodes', [PincodeController::class, 'import']);
    });
